# Generated by Django 4.2.5 on 2023-12-05 18:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(default=datetime.datetime(2023, 12, 5, 18, 4, 8, 587655, tzinfo=datetime.timezone.utc), verbose_name='Год открытия')),
                ...
                ('date_created', models.DateTimeField(default=datetime.datetime(2023, 12, 5, 18, 4, 8, 587655, tzinfo=datetime.timezone.utc), verbose_name='Дата создания')),
                ('date_of_formation', models.DateTimeField(default=datetime.datetime(2023, 12, 5, 18, 4, 8, 587655, tzinfo=datetime.timezone.utc), verbose_name='Дата формирования')),
                ('date_complete', models.DateTimeField(default=datetime.datetime(2023, 12, 5, 18, 4, 8, 587655, tzinfo=datetime.timezone.utc), verbose_name='Дата завершения')),
                ...
                ('pioneers', models.ManyToManyField(null=True, to='discoveries.pioneer', verbose_name='Визы')),
            ],
            options={
